/// Randomised property tests for the multicoin book's buffer/tree invariant, and
...
#[test_only]
module triex::book_invariant_tests {
    ...
    /// Mid of the price band the workload quotes around, in raw quote units.
