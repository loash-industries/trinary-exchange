...
module triex::fee_schedule_tests {
    ...
    fun flat_schedule_validates() {
        flat_schedule(22_000_000, 18_000_000).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun zero_maker_fee_is_allowed() {
        ...
        fee_schedule::from_vectors(
            vector[0, 200_000_000],
            vector[22_000_000, 19_000_000],
            vector[18_000_000, 0],
    ...
    fun empty_schedule_rejected() {
        fee_schedule::from_vectors(vector[], vector[], vector[]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun first_tier_must_start_at_zero() {
        ...
        fee_schedule::from_vectors(vector[1], vector[22_000_000], vector[18_000_000]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun duplicate_thresholds_rejected() {
        fee_schedule::from_vectors(
            vector[0, 200_000_000, 200_000_000],
            vector[22_000_000, 19_000_000, 16_000_000],
    ...
    fun descending_thresholds_rejected() {
        fee_schedule::from_vectors(
            vector[0, 400_000_000, 200_000_000],
            vector[22_000_000, 19_000_000, 16_000_000],
            vector[18_000_000, 15_500_000, 13_000_000],
        ).validate(MIN_TAKER, MAX_TAKER, MAX_MAKER, FEE_MULTIPLE);
    }
    ...
    fun rising_taker_rate_rejected() {
        ...
        fee_schedule::from_vectors(
            vector[0, 200_000_000],
            vector[19_000_000, 22_000_000],
            vector[18_000_000, 15_500_000],
        ).validate(MIN_TAKER, MAX_TAKER, MAX_MAKER, FEE_MULTIPLE);
    }
    ...
    fun taker_rate_above_cap_rejected() {
        fee_schedule::from_vectors(vector[0], vector[MAX_TAKER + FEE_MULTIPLE], vector[0]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun taker_rate_off_multiple_rejected() {
        fee_schedule::from_vectors(vector[0], vector[22_000_001], vector[18_000_000]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun maker_rate_off_multiple_rejected() {
        fee_schedule::from_vectors(vector[0], vector[22_000_000], vector[18_000_001]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun over_long_schedule_rejected() {
        ...
        fee_schedule::from_vectors(min_turnovers, taker_fees, maker_fees).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun equal_rates_across_tiers_validate() {
        ...
        fee_schedule::from_vectors(
            vector[0, 200_000_000, 1_000_000_000],
            vector[22_000_000, 22_000_000, 19_000_000],
    ...
    fun taker_rate_at_the_floor_validates() {
        fee_schedule::from_vectors(vector[0], vector[MIN_TAKER], vector[0]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
    ...
    fun taker_rate_at_the_cap_validates() {
        fee_schedule::from_vectors(vector[0], vector[MAX_TAKER], vector[MAX_MAKER]).validate(
            MIN_TAKER,
            MAX_TAKER,
            MAX_MAKER,
            FEE_MULTIPLE,
