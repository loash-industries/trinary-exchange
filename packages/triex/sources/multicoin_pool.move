...
public fun modify_order<QuoteAsset>(
    ...
    pool_inner
        .vault
        .settle_trading_account(settled, owed, trading_account, trade_proof, option::none(), ctx);
...
fun place_order_int<QuoteAsset>(
    ...
    let order_info = {
        ...
        pool_inner
            .vault
            .settle_trading_account(settled, owed, trading_account, trade_proof, fee_deposit, ctx);
