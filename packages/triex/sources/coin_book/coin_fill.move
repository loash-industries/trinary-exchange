...
///
/// Coin-pool fork of `triex::fill`. Identical apart from `maker_order_id` being
/// the encoded `u128` key of the coin book rather than a `u64` serial. Fee and
/// settlement logic is shared verbatim — any change here must land in
/// `triex::fill` too, and vice versa.
module triex::coin_fill {
