...
// VENDORED VERBATIM from MystenLabs/deepbookv3,
// packages/deepbook/sources/helper/big_vector.move. The only local changes are
// the module path and the two `use fun` aliases, repointed from `deepbook::` to
...
module triex::big_vector {
    use sui::dynamic_field as df;

    use fun sui::object::new as TxContext.new;

    use fun triex::utils::pop_until as vector.pop_until;
    use fun triex::utils::pop_n as vector.pop_n;
